...
def inference(images, num_classes=10, is_training=False,
	...
	with tf.variable_scope(scope, 'LeNet', [images, num_classes], regularizer=slim.l2_regularizer(0.0), reuse=reuse):
		net = slim.conv2d(images, 32, [5, 5], scope='conv1')
		#print(net.get_shape) #?x28x28x32
		net = slim.max_pool2d(net, [2, 2], 2, scope='pool1')
		net = slim.conv2d(net, 64, [5, 5], scope='conv2')
		net = slim.max_pool2d(net, [2, 2], 2, scope='pool2')
		#print(net.get_shape) #?x7x7x64
		net = slim.flatten(net)
		#print(net.get_shape) #?x3136
